# SDKWork Memory Open API SDK

This is the SDK family root for the `sdkwork-memory-open-api` OpenAPI authority.
...
- Declared generated client: `SdkworkMemoryOpenClient`

Generated transport output, when materialized, belongs under:

- `sdkwork-memory-sdk-typescript/generated/server-openapi`
