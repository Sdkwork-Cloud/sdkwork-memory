...
const baselinePath = path.join(
  root,
  'database/ddl/baseline/postgres/0001_memory_legacy_baseline.sql',
);
...
process.stdout.write(`materialized ${tableNames.length} tables into memory database contract\n`);
