...
pub use retrieval::{
    ...
    sql_structured_match_score, time_recency_score, FusedRetrievalHit, MemoryRetrievalStrategy,
    OrchestratedCandidate, RetrievalCandidate, RetrievalEventInput, RetrievalFusionPolicy,
